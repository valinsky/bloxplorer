...
def test_get_address():
    ...
    addresses.make_request.assert_called_with('GET', 'address/1234')


def test_get_scripthash():
    hash = '1234'
    addresses.get_scripthash(hash)
    addresses.make_request.assert_called_with('GET', 'scripthash/1234')


def test_get_address_tx_history():
    address = '1234'
    addresses.get_tx_history(address)
    addresses.make_request.assert_called_with('GET', 'address/1234/txs')


def test_get_scripthash_tx_history():
    hash = '1234'
    addresses.get_scripthash_tx_history(hash)
    addresses.make_request.assert_called_with('GET', 'scripthash/1234/txs')
...
def test_get_confirmed_tx_history(address, last_seen_txid, expected_url):
    ...
    addresses.make_request.assert_called_with('GET', expected_url)
...
def test_get_address_unconfirmed_tx_history():
    ...
    addresses.make_request.assert_called_with('GET', 'address/1234/txs/mempool')


def test_get_scripthash_unconfirmed_tx_history():
    hash = '1234'
    addresses.get_unconfirmed_scripthash_tx_history(hash)
    addresses.make_request.assert_called_with('GET', 'scripthash/1234/txs/mempool')


def test_get_address_utxo():
    address = '1234'
    addresses.get_utxo(address)
    addresses.make_request.assert_called_with('GET', 'address/1234/utxo')
